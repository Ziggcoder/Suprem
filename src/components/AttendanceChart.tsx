...
const AttendanceChart = () => {
    ...
    return (
        <>
            <div className="flex justify-center items-center h-fit bg-green-500" >
                <ResponsiveContainer width={400} height={330} >
                    <BarChart width={300} height={200} data={data}>
                        ...
                        <YAxis fontSize={10} />
                        {/* <Tooltip /> */}
                        <Legend verticalAlign="bottom" align="left" height={26} iconSize={10}   wrapperStyle={{ fontSize:'12px', color:'black'}} />
